...
| [personality/](personality/) | 性格倾向 | 每份一个场景的行为标记 + 那个场景特有的误判 | 拷问（收着）｜ **建设中 4/11** |
...
**[code-review/](code-review/) 和 [personality/](personality/) 没有语音版。**
后者是还没做（这个系列本身还在建设中，先把十一份写齐）；前者是做不了 ——
它的核心是读一段二十几行的代码，
